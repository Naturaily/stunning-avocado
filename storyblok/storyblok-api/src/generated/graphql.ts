...
export type GetContentNodeQueryVariables = Exact<{
  ...
  resolveRelations?: InputMaybe<Scalars['String']['input']>;
...
`;
export const GetContentNodesDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getContentNode(
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<GetContentNodeQuery>(GetContentNodeDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getContentNode',
    ...
    getContentNodes(
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<GetContentNodesQuery>(GetContentNodesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getContentNodes',
    ...
    getLinks(
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<GetLinksQuery>(GetLinksDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getLinks',
